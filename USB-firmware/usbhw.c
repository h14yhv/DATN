 ...
 *----------------------------------------------------------------------------
 *      Name:    USBHW.C
 *      Purpose: USB Hardware Layer Module for Atmel AT91SAM7S
 *      Version: V1.10
 *----------------------------------------------------------------------------
...
const BYTE  DualBankEP = 0x06;              /* Dual Bank Endpoint Bit Mask */
...
// New cmt #define AT91C_UDP_STALLSENT AT91C_UDP_ISOERROR
