...
/* SPI select pin */
#define SPI0_SEL		1 << 11		/* PA11 is used as GPIO, CS signal to SPI EEPROM */ 
...
/* Miorochip 25LC1024 SEEPROM command set */
...
extern BYTE SPIReceiveByte( void );
 ...
 /* Ham ghi du lieu vao EEPROM tai dia chi offset bat dau addr */
void EEPROM_Write(BYTE *srcbuf, DWORD length, WORD addr);
/* Ham doc du lieu tu EEPROM tai dia chi offset bat dau addr */
void EEPROM_Read(BYTE *desbuf, DWORD length, WORD addr);
